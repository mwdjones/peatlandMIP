  ...
  subroutine clm_instInit(bounds)
    ...
    if(use_hillslope) then
       call SetHillslopeSoilThickness(bounds,fsurdat, &
            soil_depth_lowland_in=1.5_r8,& ! Originally 8.5_r8 (m), changed by M.W.Jones 8/22/2023
            soil_depth_upland_in =8.0_r8) ! Originally 2.0_r8 (m), changed by M.W.Jones 8/22/2023
